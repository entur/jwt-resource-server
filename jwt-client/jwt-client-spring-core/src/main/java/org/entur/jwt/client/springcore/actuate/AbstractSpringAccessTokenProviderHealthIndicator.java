package org.entur.jwt.client.springcore.actuate;
...
public abstract class AbstractSpringAccessTokenProviderHealthIndicator extends AbstractHealthIndicator {

    protected static final Logger logger = LoggerFactory.getLogger(AbstractSpringAccessTokenProviderHealthIndicator.class);

    private final AccessTokenHealthProvider[] providers;

    private Boolean previousHealthSuccess;

    public AbstractSpringAccessTokenProviderHealthIndicator(AccessTokenHealthProvider[] statusProviders) {
        super();
