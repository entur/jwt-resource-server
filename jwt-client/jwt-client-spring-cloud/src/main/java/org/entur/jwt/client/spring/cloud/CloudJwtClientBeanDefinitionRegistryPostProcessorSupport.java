...
public class CloudJwtClientBeanDefinitionRegistryPostProcessorSupport extends JwtClientBeanDefinitionRegistryPostProcessorSupport<WebClient> {

    public CloudJwtClientBeanDefinitionRegistryPostProcessorSupport(WebClient client, SpringJwtClientProperties properties) {
