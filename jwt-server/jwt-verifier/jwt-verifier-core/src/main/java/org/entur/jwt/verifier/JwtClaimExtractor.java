...
/**
 * Extract claims from a token. Basic JSON-types are supported. Note that some implementations will return an
 * Integer instead of Long, so use the Number class.
 * 
 * @param <T> token type
 */
