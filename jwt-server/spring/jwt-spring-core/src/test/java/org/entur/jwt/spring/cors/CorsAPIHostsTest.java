...
@TestPropertySource(properties = { "entur.cors.mode=api", "entur.cors.hosts[0]=https://petstore.swagger.io", "entur.cors.hosts[1]=https://developer.entur.org", "entur.cors.hosts[2]=https://myportal.apigee.io" })
