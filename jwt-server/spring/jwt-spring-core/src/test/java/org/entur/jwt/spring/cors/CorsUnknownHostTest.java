...
/**
 * Note: This behavior can be supported by a filter in the API gateway which simply 
 * checks if the Origin header is present and if so whether the domain is known.
 *
 */
@AuthorizationServer
