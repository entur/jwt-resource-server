...
public class JwtProperties {
	...
	/** 
	 * Tenant filter (on tenant name). 
	 * This is a useful feature when configuration is shared across multiple applications, 
	 * i.e. like a common config-map in Kubernetes. 
	 */
