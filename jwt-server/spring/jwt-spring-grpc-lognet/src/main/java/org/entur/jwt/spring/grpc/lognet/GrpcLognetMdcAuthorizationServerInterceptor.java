...
public class GrpcLognetMdcAuthorizationServerInterceptor implements ServerInterceptor, Ordered {
    ...
    public GrpcLognetMdcAuthorizationServerInterceptor(JwtMappedDiagnosticContextMapper mdcMapper, int order, GrpcMdcAdapter mdcAdapter) {
