 ...
 * wall-clock checkpoints of 1, 2, 3, 4, 5, 10, 15, 30 and 60 seconds - both the throughput of
 * that individual segment and the cumulative throughput since the first call - so the
 * cache warm-up curve (cold JIT/channel/first-decode vs. steady state) is visible within
 * a single run.
 * <p>
 * See {@link DecodedJwtCacheGrpcBenchmarkColdStartNoCacheTest} for the equivalent
