...
/**
 * Example content for token's role assignment. [ { “r”: “editStops”, “o”:
 * “OST”, “z”: “01", “e”: { “EntityType”: [ “StopPlace”, "Parking" { ],
 * “StopPlaceType”: [ “!airport”, “!railStation” ], versionComment “Submode”: [
 * “!railReplacementBus” ] } } ]
 */
public class ReflectionAuthorizationServiceTest {
    ...
    public void authorizedForLegalStopPlaceTypesWhenOthersBlacklisted() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                .withEntityClassification("StopPlaceType", "!airport").withEntityClassification("StopPlaceType", "!railStation").build();
    ...
    /**
     * EntityType=StopPlace, StopPlaceType=!railStation,!airport,
    ...
    public void authorizedWithCombinationOfTwoFields() {
        ...
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                .withEntityClassification("StopPlaceType", "!railStation").withEntityClassification("StopPlaceType", "!airport").withEntityClassification("combinedField", "!railReplacementBus").build();
    ...
    public void notAuthorizedWithCombinationOfNegatedTwoFields3() {
        ...
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                .withEntityClassification("StopPlaceType", "!railStation").withEntityClassification("StopPlaceType", "!airport")
                // railReplacementBus allowed
                .withEntityClassification("combinedField", "railReplacementBus").build();
    ...
    public void handleMappedClassificationsNegation() {
        ...
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withOrganisation("OST").withAdministrativeZone("01").withEntityClassification(ENTITY_TYPE, "StopPlace")
                // classification anotherProperty mapping should lead to someField1 and
                // someField2
                .withEntityClassification("anotherProperty", "!someval2").build();
    ...
    public void authorizedForLegalSubmodeTypesWhenStarValue() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withOrganisation("OST").withAdministrativeZone("01").withEntityClassification(ENTITY_TYPE, "StopPlace").withEntityClassification("Submode", "*").build();
    ...
    public void shouldBeAuthorizedForSubmodeTypesWhenExplicitWhiteListed() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withOrganisation("OST").withAdministrativeZone("01").withEntityClassification(ENTITY_TYPE, "StopPlace").withEntityClassification("Submode", "someValue")
                .build();
    ...
    public void authorizedWhenAllTypesEntityType() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("viewStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "*").build();
    ...
    public void notAuthorizedWhenEmptyRoleAssignmentEntityClassifications() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("viewStops").withAdministrativeZone("01").withOrganisation("OST").build();
    ...
    public void notAuthorizedForIncorrectSubMode() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                .withEntityClassification("Submode", "!railReplacementBus").build();
    ...
    public void notAuthorizedForIncorrectEntityType() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("viewStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace").build();
    ...
    public void notAuthorizedToEditAirport() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                .withEntityClassification("StopPlaceType", "!airport").build();
    ...
    public void notAuthorizedToEditOnstreetBus() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                .withEntityClassification("StopPlaceType", "!onstreetBus").build();
    ...
    public void notAuthorizedToEditWhenOneBlacklisted() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                .withEntityClassification("StopPlaceType", "!airport").withEntityClassification("StopPlaceType", "!onstreetBus").build();
    ...
    public void notAuthorizedToEditWhenEnumValueContainsUnderscore() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                .withEntityClassification("StopPlaceType", "!onstreet_Bus").build();
    ...
    public void multipleEnumsShouldBeAllowed() {
        ...
        List<StopPlace.StopPlaceType> types = Arrays.asList(StopPlace.StopPlaceType.AIRPORT, StopPlace.StopPlaceType.ONSTREET_TRAM, StopPlace.StopPlaceType.ONSTREET_BUS);

        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace").build();
    ...
    public void mixNegationForEnums() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                .withEntityClassification("StopPlaceType", StopPlace.StopPlaceType.AIRPORT.toString()).withEntityClassification("StopPlaceType", "!" + StopPlace.StopPlaceType.ONSTREET_BUS.toString())
                .withEntityClassification("StopPlaceType", StopPlace.StopPlaceType.ONSTREET_TRAM.toString()).build();
    ...
    public void authorizedForCertainEnumValues() {
        ...
        for (StopPlace.StopPlaceType enumValue : StopPlace.StopPlaceType.values()) {
            RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editEnums").withAdministrativeZone("01").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace")
                    .withEntityClassification("StopPlaceType", "!" + enumValue).build();
            ...
            Arrays.stream(StopPlace.StopPlaceType.values()).forEach(otherEnum -> {
                if (otherEnum != enumValue) {
                    ...
                    assertThat("One value is not allowed " + enumValue + ", but " + otherEnum + " is", reflectionAuthorizationService.authorized(roleAssignment, stopPlace, roleAssignment.getRole()), is(true));
                }
            });
        }
    }
    ...
    public void authorizedWithSubmodeAndType() {
        RoleAssignment roleAssignment = RoleAssignment.builder().withRole("editStops").withOrganisation("OST").withEntityClassification(ENTITY_TYPE, "StopPlace").withEntityClassification("StopPlaceType", "!airport")
                .withEntityClassification("combinedfield", "!somevalue").build();
    ...
    private static class StopPlace {
        enum StopPlaceType {
            ONSTREET_BUS("onstreetBus"), ONSTREET_TRAM("onstreetTram"), AIRPORT("airport");
        ...
        public String toString() {
            return MoreObjects.toStringHelper(this).add("stopPlaceType", stopPlaceType).add("submode", submode).add("someField1", someField1).add("someField2", someField2).toString();
        }
    }
