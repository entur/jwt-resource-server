...
@TestPropertySource(properties = { "entur.cors.mode=api", "entur.cors.origins[0]=https://petstore.swagger.io", "entur.cors.origins[1]=https://developer.entur.org", "entur.cors.origins[2]=https://myportal.apigee.io", "entur.authorization.permit-all.path-matcher.patterns=/unprotected", "entur.cors.methods[0]=GET", "entur.cors.methods[1]=POST", "entur.cors.methods[2]=OPTIONS"})
