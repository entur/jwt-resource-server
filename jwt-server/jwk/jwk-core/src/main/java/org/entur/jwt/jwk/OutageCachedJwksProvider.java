 ...
 * problems / downtime, running into minutes or hours.<br><br>
 * 
        ...
        try {
        	...
        	if(!forceUpdate) {
	            ...
	            if(cache != null && cache.isValid(time)) {
	            	...
	            	// so validation of tokens will still work, but fail as soon as this cache expires
	            	...
	            	String message = "Unable to refresh keys for verification of Json Web Token signatures: " + e1.toString() + ". If this is not resolved, all incoming requests with authorization will fail as outage cache expires in "  + hours + " hours and " + minutes + " minutes.";
