...
public class JwkProviderBuilderTest {
    ...
    public void shouldCreateCachedProvider() {
        JwkProvider<?> provider = builder().rateLimited(false).cached(true).health(false).build();
    ...
    public void shouldCreateRateLimitedProvider() {
        JwkProvider<?> provider = builder().rateLimited(true).build();
    ...
    public void shouldCreateCachedAndRateLimitedProvider() {
        JwkProvider<?> provider = builder().cached(true).rateLimited(true).build();
    ...
    public void shouldCreateRetryingProvider() {
        JwkProvider<?> provider = builder().rateLimited(false).cached(false).preemptiveCacheRefresh(false).retrying(true).health(false).build();
        assertThat(provider, notNullValue());
    ...
    public void shouldCreateOutageCachedProvider() {
        JwkProvider<?> provider = builder().rateLimited(false).cached(false).preemptiveCacheRefresh(false).outageCached(true).health(false).build();
        assertThat(provider, notNullValue());
    ...
    public void shouldCreateCachedAndRateLimitedAndOutageAndRetryingProvider() {
        JwkProvider<?> provider = builder().cached(true).rateLimited(true).retrying(true).outageCached(true).health(true).build();
    ...
    public void shouldEnableCacheWhenPreemptiveCaching() {
        JwkProvider<?> provider = builder().rateLimited(false).cached(false).health(false).preemptiveCacheRefresh(true).build();
